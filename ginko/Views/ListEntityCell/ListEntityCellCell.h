...
@protocol ListEntityCellDelegate
...
@interface ListEntityCellCell : UITableViewCell <UIActionSheetDelegate>
...
@property (nonatomic, retain) id<ListEntityCellDelegate> delegate;
