...
{
    [APPDELEGATE stopTimerForDismissingActionSheet];
        ...
        switch ([actionSheet tag]) {
            case 100:
                if (type ==1) {
                    ...
                    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"tel:%@", [CommonMethods removeNanString:[arrPhone objectAtIndex:buttonIndex]]]]];
                }
                break;
            case 102:
                if (type ==1) {
            ...
            case 103:
                ...
                break;
            case 101:
                [delegate sendMail: [arrEmail objectAtIndex:buttonIndex]];
            default:
                break;
        }
    }
...
{
    NSInteger sharingStatus = 0;
    
    [self.superview.superview.superview endEditing:YES];
    if (type == 1)
        sharingStatus = [[curContact objectForKey:@"sharing_status"] integerValue];
