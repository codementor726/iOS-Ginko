...
@interface IMPhotoCameraController ()
{
...
@implementation IMPhotoCameraController
...
- (void)viewDidLoad
{
    ...
    [viewForPhotoCamera addGestureRecognizer:tapGesture];
    ...
    imageView = [[GPUImageView alloc] initWithFrame:viewForPhotoCamera.bounds];
    [viewForPhotoCamera addSubview:imageView];
    [viewForPhotoCamera sendSubviewToBack:imageView];
