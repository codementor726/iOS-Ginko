...
- (void)viewDidLoad
{
	...
	UIBarButtonItem *backButtonItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"BackArrow"] style:UIBarButtonItemStylePlain target:self action:@selector(backAction:)];
...
- (void)preparePhotos
{
    @autoreleasepool {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
           ...
           // [self.navigationItem setTitle:self.singleSelection ? @"Pick Video" : @"Pick Videos"];
        });
    }
}
